...
public class ModificarEstudiante extends JPanel {
	...
	public ModificarEstudiante() {
		...
		btnModificar.setBounds(424, 309, 223, 49);
		add(btnModificar);
		...
		lblEstado.setBounds(383, 228, 136, 21);
		add(lblEstado);
		...
		cmbEstado.setBounds(383, 248, 140, 20);
		add(cmbEstado);
		...
		lblGeneracion.setBounds(383, 173, 135, 21);
		add(lblGeneracion);
